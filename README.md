...
**Voice Leading** — four lessons on how to connect chords so the voices barely move.

- `01-common-tones` — two chords, the notes they share, and how to keep them still
- `02-smallest-move` — same Chord B, three voicings; pick the one that moves fewest semitones
- `03-circle-walk` — ii–V–I and the circle of fifths, dumb voicings vs smart voicings, side by side
- `04-quiz` — which voicing leads better?
...
This is the first substantive code I'm publishing under my own name. More lessons may come — tension & release, song form, a longer modal interchange pack. They'll land here when they're ready.

Five packs down. Built solo. More when the work earns it.
